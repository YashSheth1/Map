...
require_once('C:\xampp\htdocs\Login_v16\Excel_Plugin\php-excel-reader\excel_reader2.php');
require_once('C:\xampp\htdocs\Login_v16\Excel_Plugin\SpreadsheetReader.php');
        ...
        for($i=0;$i<$sheetCount;$i++)
        {
            ...
            foreach ($Reader as $Row)
            {
                ...
                if (!empty($SerialNumber) || !empty($latitude)) {
                    $query = "insert into village_data(SerialNumber,Latitude,Longitude) values('".$SerialNumber."','".$latitude."','".$longitude."')";
