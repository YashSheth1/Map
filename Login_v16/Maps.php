 ...
 */
// var UserName=new String(<?php echo $_POST['username'] ?> );
// var Password=new String(<?php echo $_POST['password'] ?> );
// var EmailId=new String(<?php echo $_POST['email'] ?> );


// var ProjectName=new String(<?php echo $_POST['Pname'] ?> );
// var ProjectType=new String(<?php echo $_POST['PTname'] ?> );
